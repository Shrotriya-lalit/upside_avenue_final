            ...
            <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
              ...
              <Box>
                ...
                <Stack direction="row" alignItems="flex-end" gap={1}>
                  ...
                  <Typography fontSize={14} color="#808191" mb={0.5}>for buying</Typography>
                </Stack>
              </Box>
            </Stack>
          ...
          >
            ...
            <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
              ...
              <Box mt="15px">
                ...
                <Typography mt="5px" fontSize={14} fontWeight={400} color="#808191">Current Owner</Typography>
              </Box>

              <Stack mt="15px" direction="row" alignItems="center" gap={1}>
                <Place sx={{ color: '#808191' }} />
                <Typography fontSize={14} fontWeight={400} color="#808191">Pune, Maharashtra India</Typography>
              </Stack>
